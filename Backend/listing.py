...
def add_listing():
    ...
    try:
        listing = {
            ...
            u"transaction_end_datetime": 0,
            u"transaction_status": "open",
            u"listing_image_url": image_url,
        }
        ...
        return jsonify(
            {
                "code": 500,
                "message": "An error has occurred while adding a listing. " + str(e)
            }
        ), 500
...
@app.route("/listing/user/<string:userid>", methods=['GET'])
